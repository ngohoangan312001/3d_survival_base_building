...
namespace AN
{
    public class PlayerCamera : MonoBehaviour
    {
        ...
        [SerializeField] float minimumPivot = -60; //Highest point can look up
        ...
        [Header("First Person Camera Values")]
        [SerializeField] private float firstPersonCameraZIndex = 0.4f;
        [SerializeField] private float firstPersonCameraYIndex = -0.2f;
        
        [Header("Aim Camera Values")]
        ...
        [Header("Lock On")] [SerializeField] private float lockOnRadius = 20;
        ...
        private void UpdateAimTargetPosition()
        {
            ...
            {
                player.playerAnimatorManager.aimRig.weight = 0;
            }
        }
        ...
        private void HandleCameraMode()
        {
            ...
            else
            {
                ...
                cameraObjectPosition.z = firstPersonCameraZIndex;
                cameraObjectPosition.y = firstPersonCameraYIndex;
        ...
        private void HandleRotations()
        {
            ...
            if (player.playerNetworkManager.isLockOn.Value)
            {
                ...
                float distanceFromTarget = Vector3.Distance(player.transform.position,
                ...
                cameraPivotTransform.rotation =
                    Quaternion.Slerp(cameraPivotTransform.rotation, targerRotation, lockTargetFollowSpeed);
        ...
        private void HandleCollisions()
        {
            ...
            if (Physics.SphereCast(cameraPivotTransform.position, cameraCollisionRadius, direction, out hit,
                    Mathf.Abs(targetCameraZPosition), colliderWithLayers))
            {
        ...
        private void HandleAimActionCamera()
        {
            ...
            if (player.playerNetworkManager.isAiming.Value && !player.isPerformingAction)
            {
                ...
                player.playerAnimatorManager.PlayTargetActionAnimation(
                    player.playerInventoryManager.currentRightHandWeapon.aim_State, false, false, true, true);
            }
        ...
        public void HandleLocatingLockOnTargets()
        {
            ...
            if (colliders != null && colliders.Length > 0)
            {
                ...
                if (availableTargets != null && availableTargets.Count > 0)
                {
                    ...
                    {
                        float distanceFromTarget = Vector3.Distance(player.transform.position,
                            availableTargets[e].transform.position);
        ...
        public IEnumerator WaitThenFindNewTarget()
        {
            ...
            Instance.ClearLockOnTarget();
            Instance.HandleLocatingLockOnTargets();
